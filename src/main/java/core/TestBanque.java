...
public class TestBanque {
    public static void main(String[] args) {
        ...
        compteCommun = manager.find(LivretA.class,1L);
        ...
        client.getMesComptes().addAll(Arrays.asList(livretA, assuranceVie));
        ...
        assuranceVie.getOperations().addAll(Arrays.asList(op1, op2, op3));
        ...
        if (opRetrait.getMontant() > assuranceVie.getSolde())
            ...
            assuranceVie.getOperations().add(opRetrait);
